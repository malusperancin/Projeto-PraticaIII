...
public class Culinaria implements Cloneable
{
	int    id;
	String nome;
	String descricao;
    ...
    public Culinaria (int id, String nome, String descricao, String imagem, int idPais) throws Exception
	{
		this.setId(id);
		this.setNome(nome);
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof Culinaria))
			return false;
	...
	public Culinaria (Culinaria modelo) throws Exception
	{
		if (modelo==null)
